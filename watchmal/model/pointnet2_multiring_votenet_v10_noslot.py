...
class PointNet2MultiRingVoteNetV10NoSlot(nn.Module):
    """
    Identical to PointNet2MultiRingVoteNetV10 (V6 k-NN seed attention +
    V8 cross-ring cluster attention), except slot embeddings are removed
    entirely. Separate file from V10 so V10's own config/results are
    untouched.
    ...
    def __init__(self, num_input_channels, num_rings=2, channels_per_ring=7,
                 ...
                 attn_num_heads=8, knn_k=16, cross_ring_attn_heads=4, **kwargs):
        super().__init__()
